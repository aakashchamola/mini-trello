      ...
      <div className="dashboard-header">
        <div className="header-left">
          ...
          <p className="dashboard-subtitle">
            ...
            {workspaces.length > 0 && ` across ${workspaces.length} workspace${workspaces.length !== 1 ? 's' : ''}`}
          </p>
        </div>
        <button 
            ...
            <div className="section-header">
              <h2>
                {searchQuery ? `Search Results (${filteredBoards.length})` : 
                 filterType === 'starred' ? 'Starred Boards' : 
                 filterType === 'recent' ? 'Recent Boards' : 'All Boards'}
              </h2>
            </div>
